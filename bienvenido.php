...
<html lang="en">
    <head>
        ...
        <link herf="css/sb-admin-2.css" rel="stylesheet"/>
    </head>
    <body id="page-top">
        <!-- Navigation-->
                ...
                <div class="row text-center">
                    <div class="col-md-6">
                        <span class="fa-stack fa-4x">
                            <img src="assets/img/services/logo-service1.jpg" alt="Servicio de Alquiler de Bicis" class="logo-rent">
                        </span>
                        <h4 class="my-3">Alquiler de Bicicleta</h4>
                        <p class="text-muted">Tenemos diferentes modelos y diseños de bicicleta, elije la que mas te guste</p>
                    </div>
                    <div class="col-md-6">
                        <span class="fa-stack fa-4x">
                            <img src="assets/img/services/logo-service2.png" alt="Servicio de Rutas para Bicis" class="logo-rut">
                        </span>
